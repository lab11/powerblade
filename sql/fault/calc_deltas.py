...
#['c098e5700299', 'vacuum2', '', '2017-05-09 21:01:00', '2017-05-09 21:06:00', 0, 5],
#['c098e5700299', 'vacuum2', '', '2017-05-09 20:56:00', '2017-05-09 21:00:00', 1, 5]
...
for deviceMAC, deviceName, tag, start_time, end_time, broken, downsample in query_list:
	total_scope += ((conv_to_datetime(end_time) - conv_to_datetime(start_time)).seconds)/(downsample) + 1
