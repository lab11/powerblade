...
var app = {
    ...
    bleEnabled: function () {
        ...
        app.log('Trying to connect to the proper Powerblade.');
    ...
    bleDeviceConnected: function (device) {
        app.log('Successfully connected to Powerblade');
    ...
    bleDeviceConnectionError: function (err) {
        app.log('Error connecting to Powerblade');
        app.log('Powerblade reconnecting try');
