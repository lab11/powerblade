...
var app = {
    ...
    onAppReady: function() {
        ...
        if (typeof window.gateway != "undefined") {                               // if UI opened through Summon,
            ...
            //XXX: add something to deal with advertisement here
    ...
    onParseAdvData: function(device){
        ...
        var scanRecord = new Uint8Array(device.advertising);
        ...
        if (scanRecord.length > 7 &&
            ...
            var data = new DataView(device.advertising, 7);
