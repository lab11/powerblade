...
####################
# Notes:
# maximum BLE packet length is 47 bytes @ 1 Mbps = 376 us, which I'm using for everything for now
# 47 = (1 preamble + 4 address + (2 header + 0-37 adv payload) + 3 crc). Min 10, Max 47
